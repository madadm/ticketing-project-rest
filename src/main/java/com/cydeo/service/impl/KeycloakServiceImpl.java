...
public class KeycloakServiceImpl implements KeycloakService {
    ...
    public Response userCreate(UserDTO userDTO) {
        ...
        realmResource.users().get(userId).roles().clientLevel(appClient.getId()).add(List.of(userClientRole));
    ...
    private Keycloak getKeycloakInstance(){
        return Keycloak.getInstance(keycloakProperties.getAuthServerUrl(), keycloakProperties.getMasterRealm(),
